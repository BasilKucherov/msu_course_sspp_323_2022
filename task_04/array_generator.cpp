...
int32_t* generate_array(int32_t elements_number,
...
int main(int argc, char** argv) {
  assert(argc >= 3 &&
         "Usage: array_generator <elements_number> <output_file_name> "
  ...
  int32_t* array =
      generate_array(elements_number, use_random_seed, random_seed);
